...
#Region "イベント"
    ...
    ''bt出荷指示No_Click
    ''_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    'Private Sub bt出荷指示No_Click(sender As Object, e As EventArgs)
    '    Dim frmEdit As New 出荷指示No一覧
    '    Try
    ...
    'bt検品開始No_Click
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub bt検品開始_Click(sender As Object, e As EventArgs) Handles bt検品開始.Click
        Dim frmEdit As New frmTuhanKenpin02
        Try
            Me.Close()
            Me.Dispose()
            '出荷指示No一覧呼び出し
...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            dgvSyuhin.RowCount = 0

            For iloop = 0 To 3
                iRow = dgvSyuhin.Rows.Add()


                dgvSyuhin(0, iRow).Value = False       '選択
                dgvSyuhin(1, iRow).Value = "1234567890"     '集品箱


            Next

            'ヘッダーとすべてのセルの内容に合わせて、行の高さを自動調整する
            dgvSyuhin.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells
