...
#Region "イベント"
        ...
        Try
            ...
            Select Case iIndex
                ...
                Case 12
                    ...
                    Me.Dispose()
                    'F12 実行
                    Dim frmEdit As New frmOrosiKenpin03
                    '卸エリア検品3呼び出し
                    frmEdit.ShowDialog()
    ...
    'bt検品開始No_Click
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub bt検品開始_Click(sender As Object, e As EventArgs)
        Dim frmEdit As New frmShukaSijiSel
        Try
...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            dgvkenpin2.RowCount = 0

            For iloop = 0 To 9
                iRow = dgvkenpin2.Rows.Add()


                dgvkenpin2(0, iRow).Value = "？？？？？？？？？？"       '用紙
                dgvkenpin2(1, iRow).Value = "メール便"     '送り状区分分
                dgvkenpin2(2, iRow).Value = "99"     '枚数
                dgvkenpin2(3, iRow).Value = "未検品"     '検品状態
                dgvkenpin2(4, iRow).Value = "1234567890123"     'ﾊﾞｰｺｰﾄﾞ


            Next

            'ヘッダーとすべてのセルの内容に合わせて、行の高さを自動調整する
            dgvkenpin2.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells
