...
Imports 自動倉庫管理システム.clsCommon.Library
Imports 自動倉庫管理システム.CommonModule
Imports Microsoft.VisualBasic


Public Class frmOrosiKenpin03
        ...
        Try
            ...
            Select Case iIndex
                ...
                Case 12
                    ...
                    Me.Close()
                    Me.Dispose()
                    Dim frmEdit As New frmOrosiKenpin04
                    '卸エリア検品4呼び出し
                    frmEdit.ShowDialog()
            End Select
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvkenpin3(1, iRow).Value = "あいおうえおかきくけこ"     '規格
                dgvkenpin3(2, iRow).Value = "123"     '予定検品数
                dgvkenpin3(3, iRow).Value = "123"     '実績検品数
