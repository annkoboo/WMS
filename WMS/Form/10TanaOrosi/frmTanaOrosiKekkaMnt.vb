...
Public Class frmTanaOrosiKekkaMnt
...
#Region "イベント"
    ...
    Protected Overridable Sub btnFun_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim frmEdit As New frmTanaOrosiKekkaAdd
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvZaiko(0, iRow).Value = "11-11-11-11"       '棚No
                dgvZaiko(1, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名
                dgvZaiko(2, iRow).Value = "12,345,678.99"       '在庫数
                dgvZaiko(3, iRow).Value = "123,456.99"         'ケース入数
                dgvZaiko(4, iRow).Value = "12,345,678.99"      'ケース数
                dgvZaiko(5, iRow).Value = "12,345,678.99"       'バラ数
                dgvZaiko(6, iRow).Value = "12,345,678.99"      '総数
                dgvZaiko(7, iRow).Value = "2015/06/30"   '賞味期限
                dgvZaiko(8, iRow).Value = "1234567890"   'ロットNo
                dgvZaiko(9, iRow).Value = "2015/07/01"   '入荷日
                dgvZaiko(10, iRow).Value = "2015/07/01"   '初回入荷日
                dgvZaiko(11, iRow).Value = "未検査品"       '品質区分
                dgvZaiko(12, iRow).Value = "その他"       '荷主区分
                dgvZaiko(13, iRow).Value = "○"       '予約区分
                dgvZaiko(14, iRow).Value = "1234567890123456"      '共通商品コード
                dgvZaiko(15, iRow).Value = "1234567890123456"      '関連会社コード
                dgvZaiko(16, iRow).Value = "規格あいうえおかきくけこ"   '規格
