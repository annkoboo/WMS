...
Public Class frmTanaOrosiKekkaAdd

#Region "イベント"
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    'フォーム_Load
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub 棚卸結果新規登録_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    '設定ボタン_Click
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub bt設定_Click_1(sender As Object, e As EventArgs) Handles bt設定.Click
        Me.Close()
    End Sub
