...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                iRow = dgvPick.Rows.Add()


                dgvPick(0, iRow).Value = False      '選択

                dgvPick(1, iRow).Value = "1234567890"   '出荷指示No
                dgvPick(2, iRow).Value = "設定者設定"   '設定者
                dgvPick(3, iRow).Value = "あいうえおかきくけこさしすせそ"       '得意先名
                dgvPick(4, iRow).Value = "あいうえおかきくけこさしすせそあいうえおかきくけこさしすせそあいうえおかきくけこさしすせそあいうえおかきくけこさしすせそ"       '受注メモ

            Next

            dgvPick_M.RowCount = 0

            For iloop = 0 To 9
                iRow = dgvPick_M.Rows.Add()

                dgvPick_M(0, iRow).Value = "99"      '行No
                dgvPick_M(1, iRow).Value = "11-11-11-11"     '棚No
                dgvPick_M(2, iRow).Value = "1234567890123456"      '商品コード
                dgvPick_M(3, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名
                dgvPick_M(4, iRow).Value = "規格あいうえおかきく"   '規格
                dgvPick_M(5, iRow).Value = "その他"       '予約区分
                dgvPick_M(6, iRow).Value = "12,345,678.99"       '出荷指示数量
                dgvPick_M(7, iRow).Value = "あいうえおかきくけこさしすせそあいうえおかきくけこさしすせそ"       '明細メモ
