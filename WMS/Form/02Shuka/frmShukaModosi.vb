...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            dgvSyuModosi.RowCount = 0

            For iloop = 0 To 9
                iRow = dgvSyuModosi.Rows.Add()

                dgvSyuModosi(0, iRow).Value = "11-11-11-11"     '棚No
                dgvSyuModosi(1, iRow).Value = "あいうえおかきくけこさしすせそた"     '商品名称
                dgvSyuModosi(2, iRow).Value = "2015/06/30"   '賞味期限
                dgvSyuModosi(3, iRow).Value = "1234567890"   'ロットNo
                dgvSyuModosi(4, iRow).Value = "1,234"       'ｹｰｽ数
                dgvSyuModosi(5, iRow).Value = "12,345,678.99"       'ﾊﾞﾗ数
                dgvSyuModosi(6, iRow).Value = "12,345,678.99"       '総数
                dgvSyuModosi(7, iRow).Value = "12,345,678.99"       '出荷数
                dgvSyuModosi(8, iRow).Value = "123,456.99"       'ｹｰｽ入数
                dgvSyuModosi(9, iRow).Value = "1234567890123456"      '商品コード
                dgvSyuModosi(10, iRow).Value = "あいおうえおかきくけこ"   '規格
                dgvSyuModosi(11, iRow).Value = "その他"      '予約区分
