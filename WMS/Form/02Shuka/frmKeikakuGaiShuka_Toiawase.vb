...
Public Class frmKeikakuGaiShuka_Toiawase
...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            dgvSyu_Ktoi1.RowCount = 0

            For iloop = 0 To 9
                iRow = dgvSyu_Ktoi1.Rows.Add()
                dgvSyu_Ktoi1(0, iRow).Value = "AFC本社"       '格納倉庫
                dgvSyu_Ktoi1(1, iRow).Value = "11-11-11-11"       '棚No
                dgvSyu_Ktoi1(2, iRow).Value = "○"       '予約
                dgvSyu_Ktoi1(3, iRow).Value = "1234567890123456"      '商品コード
                dgvSyu_Ktoi1(4, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名

                dgvSyu_Ktoi1(5, iRow).Value = "2015/06/30"   '賞味期限
                dgvSyu_Ktoi1(6, iRow).Value = "1234567890"       'ロットNo
                dgvSyu_Ktoi1(7, iRow).Value = "2015/05/01"   '入荷日
                dgvSyu_Ktoi1(8, iRow).Value = "2015/05/01"   '初回入荷日
                dgvSyu_Ktoi1(9, iRow).Value = "12,345,678.99"       '引当可能数
                dgvSyu_Ktoi1(10, iRow).Value = "12,345,678.99"       '出荷数量
                dgvSyu_Ktoi1(11, iRow).Value = "備考備考あいうえおかきくけこさしすせそたちつてとなにぬねのは"       '備考
                dgvSyu_Ktoi1(12, iRow).Value = "未検査品"       '品質区分
                dgvSyu_Ktoi1(13, iRow).Value = "その他"       '荷主区分
            Next

            dgvSyu_Ktoi2.RowCount = 0

            For iloop = 0 To 9
                iRow = dgvSyu_Ktoi2.Rows.Add()
                dgvSyu_Ktoi2(0, iRow).Value = "AFC本社"       '格納倉庫
                dgvSyu_Ktoi2(1, iRow).Value = "11-11-11-11"       '棚No
                dgvSyu_Ktoi2(2, iRow).Value = "○"       '予約
                dgvSyu_Ktoi2(3, iRow).Value = "1234567890123456"      '商品コード
                dgvSyu_Ktoi2(4, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名
                dgvSyu_Ktoi2(5, iRow).Value = "2015/06/30"   '賞味期限
                dgvSyu_Ktoi2(6, iRow).Value = "1234567890"       'ロットNo
                dgvSyu_Ktoi2(7, iRow).Value = "2015/05/01"   '入荷日
                dgvSyu_Ktoi2(8, iRow).Value = "2015/05/01"   '初回入荷日
                dgvSyu_Ktoi2(9, iRow).Value = "12,345,678.99"       '出荷数量
                dgvSyu_Ktoi2(10, iRow).Value = "備考備考あいうえおかきくけこさしすせそたちつてとなにぬねのは"       '備考
                dgvSyu_Ktoi2(11, iRow).Value = "未検査品"       '品質区分
                dgvSyu_Ktoi2(12, iRow).Value = "その他"       '荷主区分
            Next
