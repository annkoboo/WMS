...
#Region "イベント"
    ...
    '出荷止めリスト発行_Click
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub 出荷止めリスト発行_Click(sender As Object, e As EventArgs)
        Dim frmEdit As New frmShukaStopLstPrt
        Try
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvSyu_Tome_Set(0, iRow).Value = False       '選択
                'dgvSyu_Tome_Set(1, iRow).Value = "2015/05/01"       '出荷指示日
                dgvSyu_Tome_Set(1, iRow).Value = "1234567890"       '出荷指示No
                dgvSyu_Tome_Set(2, iRow).Value = "1234567890123"       '出荷先コード
                dgvSyu_Tome_Set(3, iRow).Value = "あいうえおかきくけこさしすせそ"   '出荷先名称
                dgvSyu_Tome_Set(4, iRow).Value = "荷合せ済"   '出荷状態
                dgvSyu_Tome_Set(5, iRow).Value = "あいうえおかきくけこさしすせそあいうえおかきくけこさしすせそあいうえおかきくけこさしすせそあいうえおかきくけこさしすせそ"       '受注メモ
            ...
            '解除
            dgvSyu_Tome_Can.RowCount = 0

            For iloop = 0 To 9
                iRow = dgvSyu_Tome_Can.Rows.Add()

                dgvSyu_Tome_Can(0, iRow).Value = False       '選択
                'dgvSyu_Tome_Can(1, iRow).Value = "2015/05/01"       '出荷指示日
                dgvSyu_Tome_Can(1, iRow).Value = "1234567890"       '出荷指示No
                dgvSyu_Tome_Can(2, iRow).Value = "1234567890123"       '出荷先コード
                dgvSyu_Tome_Can(3, iRow).Value = "あいうえおかきくけこさしすせそ"   '出荷先名称
                dgvSyu_Tome_Can(4, iRow).Value = "荷合せ済"   '出荷状態
                dgvSyu_Tome_Can(5, iRow).Value = "あいうえおかきくけこさしすせそあいうえおかきくけこさしすせそあいうえおかきくけこさしすせそあいうえおかきくけこさしすせそ"       '受注メモ
