...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                iRow = dgvRabel.Rows.Add()

                dgvRabel(0, iRow).Value = "1234567"       '入庫ラベルNo
                dgvRabel(1, iRow).Value = "2015/06/30"    '賞味期限
                dgvRabel(2, iRow).Value = "1234567890"    'ロットNo
                dgvRabel(3, iRow).Value = "2015/05/01"    '入荷日
                dgvRabel(4, iRow).Value = "2015/05/01"    '初回入荷日
                dgvRabel(5, iRow).Value = "1234567"       '製造指図No
                dgvRabel(6, iRow).Value = "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほ"       '備考
                dgvRabel(7, iRow).Value = "1234567890123456"       '共通商品コード
                dgvRabel(8, iRow).Value = "品名略称あいうえおかきくけこあい"     '品名略称
                dgvRabel(9, iRow).Value = "未検査品"       '品質区分
                dgvRabel(10, iRow).Value = "その他"       '荷主区分
                dgvRabel(11, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"       '商品名
                dgvRabel(12, iRow).Value = "規格あいうえおかきくけこ"       '規格
