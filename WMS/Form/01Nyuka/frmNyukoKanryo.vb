...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            '容器番号単位
            dgvKanryou_Youki.RowCount = 0

            For iloop = 0 To 9
                iRow = dgvKanryou_Youki.Rows.Add()


                dgvKanryou_Youki(0, iRow).Value = "1234567"       '入庫ラベルNo
                dgvKanryou_Youki(1, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名
                dgvKanryou_Youki(2, iRow).Value = "12,345,678.99"       '総数
                dgvKanryou_Youki(3, iRow).Value = "2015/06/30"   '賞味期限

                dgvKanryou_Youki(4, iRow).Value = "1234567890"       'ロットNo
                dgvKanryou_Youki(5, iRow).Value = "2015/05/01"   '入荷日
                dgvKanryou_Youki(6, iRow).Value = "2015/05/01"   '初回入荷日
                dgvKanryou_Youki(7, iRow).Value = "未検査品"       '品質区分
                dgvKanryou_Youki(8, iRow).Value = "その他"       '荷主区分
                dgvKanryou_Youki(9, iRow).Value = "1234567890123456"       '共通商品コード
                dgvKanryou_Youki(10, iRow).Value = "備考備考あいうえおかきくけこさしすせそたちつてとなにぬねのは"     '備考

                dgvKanryou_Youki(11, iRow).Value = "規格あいうえおかきくけこ"   '規格
                dgvKanryou_Youki(12, iRow).Value = "123,456.99"       'ケース入数
                dgvKanryou_Youki(13, iRow).Value = "1,234"       'ケース数
                dgvKanryou_Youki(14, iRow).Value = "12,345,678.99"       'バラ数

            Next


            dgvNyuko_No.RowCount = 0
            For iloop = 0 To 9
                iRow = dgvNyuko_No.Rows.Add()

                dgvNyuko_No(0, iRow).Value = "123456"       '入庫ラベルNo

            Next


            '入庫ﾗﾍﾞﾙ単位
            dgvNyuko_Rabel.RowCount = 0

            For iloop = 0 To 9
                iRow = dgvNyuko_Rabel.Rows.Add()


                dgvNyuko_Rabel(0, iRow).Value = "1234567"       '入庫ラベルNo
                dgvNyuko_Rabel(1, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名
                dgvNyuko_Rabel(2, iRow).Value = "12,345,678.99"       '総数
                dgvNyuko_Rabel(3, iRow).Value = "2015/06/30"   '賞味期限

                dgvNyuko_Rabel(4, iRow).Value = "1234567890"       'ロットNo
                dgvNyuko_Rabel(5, iRow).Value = "2015/05/01"   '入荷日
                dgvNyuko_Rabel(6, iRow).Value = "2015/05/01"   '初回入荷日
                dgvNyuko_Rabel(7, iRow).Value = "その他"       '荷主区分
                dgvNyuko_Rabel(8, iRow).Value = "未検査品"       '品質区分
                dgvNyuko_Rabel(9, iRow).Value = "1234567890123456"       '共通商品コード
                dgvNyuko_Rabel(10, iRow).Value = "備考備考あいうえおかきくけこさしすせそたちつてとなにぬねのは"     '備考
                dgvNyuko_Rabel(11, iRow).Value = "規格あいうえおかきくけこ"   '規格
                dgvNyuko_Rabel(12, iRow).Value = "123,456.99"       'ケース入数
                dgvNyuko_Rabel(13, iRow).Value = "1,234"       'ケース数
                dgvNyuko_Rabel(14, iRow).Value = "12,345,678.99"       'バラ数
