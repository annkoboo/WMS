...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                iRow = dgvTumi.Rows.Add()

                dgvTumi(0, iRow).Value = False       '選択
                dgvTumi(1, iRow).Value = "11-11-11-11"       '棚No
                dgvTumi(2, iRow).Value = "123456"     '容器番号
                dgvTumi(3, iRow).Value = "12,345,678.99"   '総数
                dgvTumi(4, iRow).Value = "99"       '混載
                dgvTumi(5, iRow).Value = "1,234"       '参考ケース数
