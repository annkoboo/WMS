    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvZaiko(0, iRow).Value = "2015/06/30"   '賞味期限
                dgvZaiko(1, iRow).Value = "1234567890"       'ロットNo
                dgvZaiko(2, iRow).Value = "2015/01/30"   '初回入荷日

                dgvZaiko(3, iRow).Value = "1234567"       '入庫ﾗﾍﾞﾙ

                dgvZaiko(4, iRow).Value = "未検査品"       '品質区分
                dgvZaiko(5, iRow).Value = "その他"       '予約区分
                dgvZaiko(6, iRow).Value = "12,345,678.99"       '在庫数
                dgvZaiko(7, iRow).Value = "11-11-11-11"       '棚No
