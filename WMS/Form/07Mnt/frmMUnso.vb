...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            dgvSyubetsu.RowCount = 0

            For iloop = 0 To 9
                iRow = dgvSyubetsu.Rows.Add()

                dgvSyubetsu(0, iRow).Value = "9999999"               '運送会社コード
                dgvSyubetsu(1, iRow).Value = "あいうえおかきくけこ"  '運送会社名称
