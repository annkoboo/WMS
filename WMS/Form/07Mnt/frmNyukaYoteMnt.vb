...
#Region "イベント"
    ...
    Protected Overridable Sub btnFun_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim frmEdit As New frmNyukaYoteLstPrt
    ...
    '共通商品コード一覧_Click
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub btnKyotuHinCd_Click(sender As Object, e As EventArgs) Handles btnKyotuHinCd.Click
...
#Region "関数"
    ...
    Private Sub InitCommon()
        ...
        Try
            ...
            '表示ﾃｷｽﾄ
            btnFXX(1).Text = "入荷予定" & vbCrLf & "データ一覧" & vbCrLf & "発行"
            btnFXX(2).Text = "登録"
            btnFXX(3).Text = ""
            btnFXX(4).Text = "削除"
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvNyuka(0, iRow).Value = "11-11-11-11"       '棚No
                dgvNyuka(1, iRow).Value = "1234567890123456"      '共通商品コード
                dgvNyuka(2, iRow).Value = "商品名あいうえおかきくけこさしす"     '商品略称

                dgvNyuka(3, iRow).Value = "1234567890123456"      '関連会社コード

                dgvNyuka(4, iRow).Value = "あいおうえおかきくけこ"   '規格
                dgvNyuka(5, iRow).Value = "2015/06/30"   '賞味期限
                dgvNyuka(6, iRow).Value = "1234567890"       'ロットNo

                dgvNyuka(7, iRow).Value = "12,345,678.99"       '在庫数
                dgvNyuka(8, iRow).Value = "2015/07/01"   '入荷日

                dgvNyuka(9, iRow).Value = "未検査品"       '品質区分
                dgvNyuka(10, iRow).Value = "その他"       '荷主区分
                dgvNyuka(11, iRow).Value = "その他"       '予約区分
