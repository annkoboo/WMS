    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvZaiko(0, iRow).Value = "あいうえおかきくけこ"       '格納倉庫
                dgvZaiko(1, iRow).Value = "11-11-11-11"       '棚No
                dgvZaiko(2, iRow).Value = "1234567890123456"      '共通商品コード
                dgvZaiko(3, iRow).Value = "商品名あいうえおかきくけこさしす"     '商品略称

                dgvZaiko(4, iRow).Value = "1234567890123456"      '関連会社コード

                dgvZaiko(5, iRow).Value = "あいおうえおかきくけこ"   '規格
                dgvZaiko(6, iRow).Value = "2015/06/30"   '賞味期限
                dgvZaiko(7, iRow).Value = "1234567890"       'ロットNo

                dgvZaiko(8, iRow).Value = "12,345,678.99"       '在庫数
                ...
                dgvZaiko(13, iRow).Value = "その他"       '予約区分
