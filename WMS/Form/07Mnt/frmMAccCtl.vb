...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                iRow = dgvJiyuu.Rows.Add()

                dgvJiyuu(0, iRow).Value = "あいうえおかきくけこさしすせそ"   '画面名称
                dgvJiyuu(1, iRow).Value = "○"                               '管理者
                dgvJiyuu(2, iRow).Value = "○"                               'リーダ
                dgvJiyuu(3, iRow).Value = "○"                               'オペレータ
                dgvJiyuu(4, iRow).Value = "○"                               '他部署
                dgvJiyuu(5, iRow).Value = "○"                               '物流

                dgvJiyuu(6, iRow).Value = "○"                               '予備1
                dgvJiyuu(7, iRow).Value = "○"                               '予備2
                dgvJiyuu(8, iRow).Value = "○"                               '予備3
                dgvJiyuu(9, iRow).Value = "○"                               '予備4
            Next
