...
#Region "イベント"
    ...
    Protected Overridable Sub btnFun_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim frmEdit As New frmShukaYoteLstPrt
...
#Region "関数"
    ...
    Private Sub InitCommon()
        ...
        Try
            ...
            '表示ﾃｷｽﾄ
            btnFXX(1).Text = "出荷予定" & vbCrLf & "データ一覧" & vbCrLf & "発行"
            btnFXX(2).Text = "登録"
            btnFXX(3).Text = ""
            btnFXX(4).Text = "削除"
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvSyuka(0, iRow).Value = "1234567890"       '出荷指示No
                dgvSyuka(1, iRow).Value = "1234567890123"    '出荷先コード
                dgvSyuka(2, iRow).Value = "あいうえおかきくけこさしすせそ"       '出荷先名称
                dgvSyuka(3, iRow).Value = "999"       '出荷行No


                dgvSyuka(4, iRow).Value = "1234567890123456"      '共通商品コード
                dgvSyuka(5, iRow).Value = "商品名あいうえおかきくけこさしす"     '商品名

                dgvSyuka(6, iRow).Value = "1234567890123456"      '関連会社コード

                dgvSyuka(7, iRow).Value = "あいおうえおかきくけこ"   '規格
                dgvSyuka(8, iRow).Value = "その他"       '予約区分

                dgvSyuka(9, iRow).Value = "12,345,678.99"       '出荷指示数量

                dgvSyuka(10, iRow).Value = "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゐゆゑよらりる"       '受注メモ
                dgvSyuka(11, iRow).Value = "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほ"       '明細メモ
