...
#Region "イベント-フォーム-"
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.MaximumSize = New System.Drawing.Size(2500, 2500)
...
#Region "イベント"
    ...
    '共通商品コード一覧_Click
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub btnKyotuHinCd_Click(sender As Object, e As EventArgs) Handles btnKyotuHinCd.Click, btnKyotuHinCd2.Click
...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                iRow = dgvSyuka.Rows.Add()
                dgvSyuka(0, iRow).Value = "1234567890123456"                    '共通商品コード
                dgvSyuka(1, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名
                dgvSyuka(2, iRow).Value = "あいおうえおかきくけこ"         '規格
                dgvSyuka(3, iRow).Value = "品名略あいうえおかきくけこさしす"         '品名略称
                dgvSyuka(4, iRow).Value = "1234567890123"          'JANコード
                dgvSyuka(5, iRow).Value = "1234"           '基準数量単位
                dgvSyuka(6, iRow).Value = "123,456.99"     'ケース入数
                dgvSyuka(7, iRow).Value = "CS"           'ケース単位
                dgvSyuka(8, iRow).Value = "99"      '品質保証期間
                dgvSyuka(9, iRow).Value = "YYYY/MM/DD"      '出荷期限
                dgvSyuka(10, iRow).Value = "12,345,678"       '通販安全在庫数
                dgvSyuka(11, iRow).Value = "12,345,678"       '卸安全在庫数
                dgvSyuka(12, iRow).Value = "12,345,678"       '発注ロット数
                dgvSyuka(13, iRow).Value = "1234567890123456"       'ITFコード
                dgvSyuka(14, iRow).Value = "1234567890123456"                '関連会社コード
                dgvSyuka(15, iRow).Value = "123456"                          '商品分類1
                dgvSyuka(16, iRow).Value = "123456"                          '商品分類2
                dgvSyuka(17, iRow).Value = "123456"                          '商品分類3
                dgvSyuka(18, iRow).Value = "何もしない"                          '品質処理区分
