...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                iRow = dgvArea.Rows.Add()

                dgvArea(0, iRow).Value = "格納倉庫おかきくけこ"             '格納倉庫
                dgvArea(1, iRow).Value = "99"                               'エリアNo
                dgvArea(2, iRow).Value = "あいうえおかきくけこさしすせそたちつてと"   'エリア名称
                dgvArea(3, iRow).Value = "あいうえおかきくけこさしすせそ"             'エリア属性｛バックヤード、通販C品ピッキング、通販DPSピッキング、通販大物冷凍ピッキング、卸通常ピッキング、卸大物冷凍ピッキング｝
                dgvArea(4, iRow).Value = "あいうえおかきくけこさしすせそ"             'ハード属性｛自動倉庫、平置倉庫、DPS｝
                dgvArea(5, iRow).Value = "99"                               '属性内オーダー
