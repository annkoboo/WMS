    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvZaiko(3, iRow).Value = "未検査品"       '品質区分
                dgvZaiko(4, iRow).Value = "その他"       '予約区分
                dgvZaiko(5, iRow).Value = "12,345,678.99"       '在庫数
                dgvZaiko(6, iRow).Value = "11-11-11-11"       '棚No
