...
#Region "イベント"
    ...
    'bt事由コード_Click
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub bt事由コード_Click(sender As Object, e As EventArgs) Handles bt事由コード.Click
        Dim frmEdit As New frmMJiyuSel
        Try
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvJiyuu(0, iRow).Value = "あいうえおかきくけこさしすせそたちつてと"    '事象
                dgvJiyuu(1, iRow).Value = "99"                                          '事由コード
                dgvJiyuu(2, iRow).Value = "あいうえおかきくけこさしすせそ"             '事由名称
