...
#Region "イベント-フォーム-"
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Dim stbPnl1 As New StatusBarPanel
            stbPnl1.Text = "ログイン名"
            stbPnl1.Width = 120
            stbInfo.Panels.Add(stbPnl1)
...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            dgvHojyu_T.RowCount = 0

            For iloop = 0 To 9
                iRow = dgvHojyu_T.Rows.Add()
                dgvHojyu_T(0, iRow).Value = False       '選択
                dgvHojyu_T(1, iRow).Value = "11-11-11-11"       '補充先棚No
                dgvHojyu_T(2, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名
                dgvHojyu_T(3, iRow).Value = "規格あいうえおかきくけこ"   '規格
                dgvHojyu_T(4, iRow).Value = "12,345,678"       '在庫数
                dgvHojyu_T(5, iRow).Value = "12,345,678"       '最小在庫数
                dgvHojyu_T(6, iRow).Value = "1234567890123456"       '共通商品コード

            Next


            dgvHojyu_O.RowCount = 0
            For iloop = 0 To 9
                iRow = dgvHojyu_O.Rows.Add()

                dgvHojyu_O(0, iRow).Value = False       'DPS
                dgvHojyu_O(1, iRow).Value = True '自動
                dgvHojyu_O(2, iRow).Value = "1234567890123456"      '商品コード
                dgvHojyu_O(3, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名
                dgvHojyu_O(4, iRow).Value = "2015/06/30"       '最終出荷賞味期限
                dgvHojyu_O(5, iRow).Value = "12,345,678.99"       '在庫数
                dgvHojyu_O(6, iRow).Value = "12,345,678.99"       '出荷指示数量
                dgvHojyu_O(7, iRow).Value = "12,345,678.99"       '不足数量
            ...
            dgvHojyu_K.RowCount = 0
            For iloop = 0 To 9
                iRow = dgvHojyu_K.Rows.Add()
                dgvHojyu_K(0, iRow).Value = False       '選択
                'dgvHojyu_K(1, iRow).Value = "通常"       '補充区分
                dgvHojyu_K(1, iRow).Value = "11-11-11-11"       '補充先棚No
                dgvHojyu_K(2, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名
                dgvHojyu_K(3, iRow).Value = "規格あいうえおかきくけこ"   '規格
                dgvHojyu_K(4, iRow).Value = "その他"   '予約区分
                dgvHojyu_K(5, iRow).Value = "12,345,678"       '在庫数
                dgvHojyu_K(6, iRow).Value = "12,345,678"       '最小在庫数
                dgvHojyu_K(7, iRow).Value = "1234567890123456"       '共通商品コード
            Next
