...
Public Class frmHojuLstPrt

#Region "イベント"
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    'フォーム_Load
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub 補充作業リスト出力_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvHojyu_List(0, iRow).Value = "99"       '補充先ｴﾘｱNo
                'dgvHojyu_List(1, iRow).Value = "12345"     '台車No
