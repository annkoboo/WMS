...
Public Class frmShukaSijiSel

#Region "イベント"
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    'フォーム_Load
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub 出荷指示No一覧_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvSyu_Siji(0, iRow).Value = "1234567890"       '出荷指示No
                dgvSyu_Siji(1, iRow).Value = "あいうえおかきくけこさしすせそ"     'お客様名
                dgvSyu_Siji(2, iRow).Value = "123"   '未検品数
                dgvSyu_Siji(3, iRow).Value = "123"       '検品数
