...
Public Class frmShukaModosiLstPrt

#Region "イベント"
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    'フォーム_Load
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub 出荷戻し作業リスト発行_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    '発行ボタン_Click
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub bt発行_Click(sender As Object, e As EventArgs) Handles bt発行.Click
        Me.Close()
    End Sub
