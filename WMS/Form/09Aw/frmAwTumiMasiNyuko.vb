...
Public Class frmAwTumiMasiNyuko
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvTanaoroshi(7, iRow).Value = "1234567890123456"       '共通商品コード
                dgvTanaoroshi(8, iRow).Value = "2015/06/30"     '賞味期限
                dgvTanaoroshi(9, iRow).Value = "1234567890"     'ﾛｯﾄNo
                dgvTanaoroshi(10, iRow).Value = "2015/06/30"     '入荷日
                dgvTanaoroshi(11, iRow).Value = "2015/06/30"     '初回入荷日
                dgvTanaoroshi(12, iRow).Value = "未検査品"     '品質区分
                dgvTanaoroshi(13, iRow).Value = "その他"     '荷主区分
