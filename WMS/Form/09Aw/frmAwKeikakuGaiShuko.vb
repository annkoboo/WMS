...
Public Class frmAwKeikakuGaiShuko
...
#Region "関数"
    ...
    Private Sub InitCommon()
        ...
        Try
            ...
            btnFXX(11).Enabled = True 'Demo用に有効化
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            '    dgvNyuka(1, iRow).Value = "商品名あいうえおかきくけこさしす"     '商品名
            '    dgvNyuka(2, iRow).Value = "規格あいうえおかきく"   '規格
            '    dgvNyuka(3, iRow).Value = "123,456"       '入荷予定数量
            '    dgvNyuka(4, iRow).Value = "12345678"       '入荷予定No
            '    dgvNyuka(5, iRow).Value = "123"       '行No
            '    dgvNyuka(6, iRow).Value = "ﾋﾞｺｳ1ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿ"       '備考1
            '    dgvNyuka(7, iRow).Value = "ﾋﾞｺｳ2ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿ"       '備考2
