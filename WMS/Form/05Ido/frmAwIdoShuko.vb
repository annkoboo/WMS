    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvZaiko(0, iRow).Value = False '選択
                ...
                dgvZaiko(5, iRow).Value = "2015/07/01"   '入荷日
                dgvZaiko(6, iRow).Value = "12,345,678.99"       '在庫数
                dgvZaiko(7, iRow).Value = "○"       '予約区分
                dgvZaiko(8, iRow).Value = "備考あいうえおかきくけこさしすせそたちつてとなにぬねのはひふ"     '備考
                dgvZaiko(9, iRow).Value = "予約理由あいうえおかきくけこさしすせそたちつてとなにぬねのは"     '予約理由
                dgvZaiko(10, iRow).Value = "未検査品"       '品質区分
                dgvZaiko(11, iRow).Value = "その他"       '荷主区分
            Next
