    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvZaiko(1, iRow).Value = "1234567890123456"      '共通商品コード
                dgvZaiko(2, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名
                dgvZaiko(3, iRow).Value = "2015/06/30"   '賞味期限
                dgvZaiko(4, iRow).Value = "1234567890"       'ロットNo
                dgvZaiko(5, iRow).Value = "2015/07/01"   '入荷日
                dgvZaiko(6, iRow).Value = "2015/07/01"   '初回入荷日
                dgvZaiko(7, iRow).Value = "12,345,678.99"       '移動数
                dgvZaiko(8, iRow).Value = "移動元作業者"       '移動元作業者
