...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                iRow = dgvZone.Rows.Add()

                dgvZone(0, iRow).Value = "9"            'ゾーンNo
                dgvZone(1, iRow).Value = "99999"        '容器番号
                dgvZone(2, iRow).Value = "9999999999"   '出荷指示No
                dgvZone(3, iRow).Value = "Z,ZZ9"        '作業残棚数
            ...
            For iloop = 0 To 9
                ...
                dgvTana(0, iRow).Value = "99-99-99-99"                  '棚No
                dgvTana(1, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"   '商品名
                dgvTana(2, iRow).Value = "規格あいうえおかきくけこ"  '規格
                dgvTana(3, iRow).Value = "ピック中"  '状態｛ピック中、ピック済｝
                dgvTana(4, iRow).Value = "ZZ,ZZZ,ZZ9"  '出荷指示数
