    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvWorker(0, iRow).Value = "YYYY/MM/DD HH:MM:SS"   '日時
                dgvWorker(1, iRow).Value = "9999"    '区分
                dgvWorker(2, iRow).Value = "あいうえおかきくけこさしすせそたちつてと"    '伝送データ
