...
#Region "イベント"
    ...
    Protected Overridable Sub btnFun_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim frmEdit As New frmDPMUserAdd
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvWork(0, iRow).Value = "99"          'ラインNo
                dgvWork(1, iRow).Value = "9999"   'ゾーンNo
                dgvWork(2, iRow).Value = "99999"  '作業者コード
                dgvWork(3, iRow).Value = "あいうえおかきくけこ"  '作業者名
