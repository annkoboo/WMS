    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvSyuka(0, iRow).Value = "2015/07/01"   '出荷日
                dgvSyuka(1, iRow).Value = "通販"       '指示区分

                dgvSyuka(2, iRow).Value = "あいうえおかきくけこさしすせそ"     '出荷先名

                dgvSyuka(3, iRow).Value = "2015/06/30"   '賞味期限
                dgvSyuka(4, iRow).Value = "1234567890"       'ロットNo
                dgvSyuka(5, iRow).Value = "2015/06/30"   '初回入荷日
                dgvSyuka(6, iRow).Value = "12,345,678.99"       '出荷数

                dgvSyuka(7, iRow).Value = "1234567890123"       '出荷先コード
                dgvSyuka(8, iRow).Value = "1234567890123456"      '関連会社コード

                dgvSyuka(9, iRow).Value = "1234567890"       '出荷指示No
