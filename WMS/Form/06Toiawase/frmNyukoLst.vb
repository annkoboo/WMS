...
#Region "イベント"
    ...
    Protected Overridable Sub btnFun_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim frmEdit As New frmZaiLstPrt
    ...
    'bt表示_Click
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub bt表示_Click(sender As Object, e As EventArgs) Handles dgvNyuko.CellDoubleClick
        Dim frmEdit As New frmKanryoshaInfo
        Try
...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                iRow = dgvNyuko.Rows.Add()
                dgvNyuko(0, iRow).Value = "完了"      '状態
                dgvNyuko(1, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名
                dgvNyuko(2, iRow).Value = "123,456,789.99"      '入荷予定数
                dgvNyuko(3, iRow).Value = "123,456,789.99"         '受付数
                dgvNyuko(4, iRow).Value = "123,456,789.99"   '入荷済数
                dgvNyuko(5, iRow).Value = "1234567890"      'ロットNo
                dgvNyuko(6, iRow).Value = "2015/06/30"      '賞味期限
                dgvNyuko(7, iRow).Value = "未検査品"        '品質区分
                dgvNyuko(8, iRow).Value = "その他"         '荷主区分
                dgvNyuko(9, iRow).Value = "1234567890123456"      '共通商品コード
                dgvNyuko(10, iRow).Value = "123456"       '容器番号
                dgvNyuko(11, iRow).Value = "1234567"            '入庫ﾗﾍﾞﾙNo
                dgvNyuko(12, iRow).Value = "設定者氏名"            '設定者
                dgvNyuko(13, iRow).Value = "1234567890123456"      '関連会社コード
                dgvNyuko(14, iRow).Value = "規格あいおうえおかきくけこ"   '規格
                dgvNyuko(15, iRow).Value = "2015/06/01"   '入庫予定日
