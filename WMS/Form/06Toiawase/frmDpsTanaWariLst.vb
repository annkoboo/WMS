...
Public Class frmDpsTanaWariLst
...
#Region "イベント"
    ...
    'bt表示_Click
    '_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
    Private Sub bt表示_Click(sender As Object, e As EventArgs) Handles bt表示.Click
        Try
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvDPS(0, iRow).Value = "あいうえお"      'ゾーン
                dgvDPS(1, iRow).Value = "999"     '総棚数
                dgvDPS(2, iRow).Value = "999"      '割付数
                dgvDPS(3, iRow).Value = "123,456"   '出荷回数
            ...
            For iloop = 0 To 9
                ...
                dgvMeisai(0, iRow).Value = "11-11-11-11"       '棚No
                dgvMeisai(1, iRow).Value = "123,456"   '出荷回数
