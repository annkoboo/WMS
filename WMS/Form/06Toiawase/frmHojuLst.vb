...
#Region "関数"
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                iRow = dgvHoju.Rows.Add()

                dgvHoju(0, iRow).Value = "補充済" '補充状態｛補充元、補充先、補充済｝
                dgvHoju(1, iRow).Value = "11－11－11－11"       '補充元棚No
                dgvHoju(2, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ" '商品名称
                dgvHoju(3, iRow).Value = "12,345,678" '補充数
                dgvHoju(4, iRow).Value = "22-22-22-22"       '補充先棚No
                dgvHoju(5, iRow).Value = "1234567890123456" '共通商品コード
                dgvHoju(6, iRow).Value = "作業者作業" '設定者
                dgvHoju(7, iRow).Value = "作業者作業" '補充元作業者
                dgvHoju(8, iRow).Value = "作業者作業" '補充先作業者
                dgvHoju(9, iRow).Value = "12,345,678" '最小在庫数
                dgvHoju(10, iRow).Value = "通常" '補充区分｛通常、緊急｝
                dgvHoju(11, iRow).Value = "規格あいおうえおかきくけこ" '規格
            Next
