    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvSyuKigen(0, iRow).Value = "1234567890123456" '共通商品コード
                dgvSyuKigen(1, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ" '商品名称
                dgvSyuKigen(2, iRow).Value = "規格あいおうえおかきくけこ" '規格

                dgvSyuKigen(3, iRow).Value = "YYYY/MM/DD" '未出荷期間


                dgvSyuKigen(4, iRow).Value = "12,345,678" '総在庫数
                dgvSyuKigen(5, iRow).Value = "12,345,678" '自動倉庫在庫数
                dgvSyuKigen(6, iRow).Value = "12,345,678" '平置倉庫在庫数
