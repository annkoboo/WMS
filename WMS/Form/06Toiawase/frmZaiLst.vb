...
#Region "関数"
    ...
    Private Sub InitCommon()
        ...
        Try
            ...
            '表示ﾃｷｽﾄ
            btnFXX(1).Text = "商品別在庫リスト発行"
            btnFXX(2).Text = "棚別在庫リスト発行"
            btnFXX(3).Text = ""
            btnFXX(4).Text = ""
    ...
    Private Sub ShowData()
        ...
        Try
            ...
            For iloop = 0 To 9
                ...
                dgvZaiko(0, iRow).Value = "1234567890123456"      '共通商品コード
                dgvZaiko(1, iRow).Value = "商品名あいうえおかきくけこさしすせそたちつてとなにぬねのはひ"     '商品名
                dgvZaiko(2, iRow).Value = "2015/06/30"   '賞味期限
                dgvZaiko(3, iRow).Value = "1234567890"       'ロットNo
                dgvZaiko(4, iRow).Value = "2015/07/01"   '入荷日
                dgvZaiko(5, iRow).Value = "2015/07/01"   '初回入荷日*
                dgvZaiko(6, iRow).Value = "12,345,678.99"       '在庫数
                dgvZaiko(7, iRow).Value = "12,345,678.99"       '引当可能数
                dgvZaiko(8, iRow).Value = "11-11-11-11"       '棚No
                dgvZaiko(9, iRow).Value = "その他"       '予約区分
                dgvZaiko(10, iRow).Value = "AFC"      '格納倉庫
                dgvZaiko(11, iRow).Value = "未検査品"       '品質区分
                dgvZaiko(12, iRow).Value = "その他"       '荷主区分
                dgvZaiko(13, iRow).Value = "予約理由あいうえおかきくけこさしすせそたちつてとなにぬねのは"       '予約理由*
                dgvZaiko(14, iRow).Value = "備考あいうえおかきくけこさしすせそたちつてとなにぬねのはひふ"       '備考*
                dgvZaiko(15, iRow).Value = "1234567890123456"      '関連会社コード
                dgvZaiko(16, iRow).Value = "規格あいおうえおかきくけこ"   '規格
                dgvZaiko(17, iRow).Value = "2015/07/01"       'データ作成日
                ...
                If iloop = 3 Then
                    For iLOOP1 = 0 To dgvZaiko.ColumnCount - 1
                        dgvZaiko.Item(iLOOP1, iRow).Style.BackColor = Color.Lime
                    Next
                ElseIf iloop = 6 Then
                    For iLOOP1 = 0 To dgvZaiko.ColumnCount - 1
                        dgvZaiko.Item(iLOOP1, iRow).Style.BackColor = Color.Yellow
                    Next
                End If
